...
export const getAllCharacters = async (pageNumber = 1): Promise<ResponseData | undefined> => {
  try {
...
export const getCharacter = async (name: string): Promise<ResponseData | undefined> => {
  try {
